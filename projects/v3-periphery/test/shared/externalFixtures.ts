...
} from '@optifusedex/v3-core/artifacts/contracts/OptiFuseV3Factory.sol/OptiFuseV3Factory.json'
import {
  abi as DEPLOYER_ABI,
  bytecode as DEPLOYER_BYTECODE,
} from '@optifusedex/v3-core/artifacts/contracts/OptiFuseV3PoolDeployer.sol/OptiFuseV3PoolDeployer.json'
import { abi as FACTORY_V2_ABI, bytecode as FACTORY_V2_BYTECODE } from '@uniswap/v2-core/build/UniswapV2Factory.json'
import { Fixture } from 'ethereum-waffle'
import { ethers, waffle } from 'hardhat'
import { IOptiFuseV3Factory, IWETH9, MockTimeSwapRouter } from '../../typechain-types'
...
const v3CoreFactoryFixture: Fixture<{ deployer: Contract; factory: IOptiFuseV3Factory }> = async ([wallet]) => {
