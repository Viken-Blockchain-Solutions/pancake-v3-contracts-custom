...
/// @title NFT positions
/// @notice Wraps OptiFuse V3 positions in the ERC721 non-fungible token interface
contract NonfungiblePositionManager is
    ...
    SelfPermit
{
    // details about the OptiFuse position
    struct Position {
    ...
    ) ERC721Permit('OptiFuse V3 Positions NFT-V1', 'PCS-V3-POS', '1') PeripheryImmutableState(_deployer, _factory, _WETH9) {
