...
import './interfaces/IOptiFuseV3PoolDeployer.sol';
import './interfaces/IOptiFuseV3Factory.sol';
...
import '@optifusedex/v3-lm-pool/contracts/interfaces/IOptiFuseV3LmPool.sol';

contract OptiFuseV3Pool is IOptiFuseV3Pool {
    ...
    /// @inheritdoc IOptiFuseV3PoolImmutables
    ...
    /// @inheritdoc IOptiFuseV3PoolState
    ...
    // liquidity mining
    IOptiFuseV3LmPool public lmPool;
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == IOptiFuseV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IOptiFuseV3PoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IOptiFuseV3PoolDerivedState
    ...
    /// @inheritdoc IOptiFuseV3PoolActions
    ...
    function mint(
        ...
        IOptiFuseV3MintCallback(msg.sender).OptiFuseV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IOptiFuseV3SwapCallback(msg.sender).OptiFuseV3SwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        IOptiFuseV3FlashCallback(msg.sender).OptiFuseV3FlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc IOptiFuseV3PoolOwnerActions
    ...
    function setLmPool(address _lmPool) external override onlyFactoryOrFactoryOwner {
      lmPool = IOptiFuseV3LmPool(_lmPool);
